...
app.post("/createEvent", authenticateToken, requireAdmin, upload.single("image"), async (req, res) => {
  try {
    ...
    console.log("Received category:", category); // Add this for debugging
    ...
    const values = [
      ...
      description, 
      organizer,
      category.toUpperCase(), // Make sure category is uppercase to match the CHECK constraint
      imagePath
    ];

    console.log("Query values:", values); // Add this for debugging
